...
<Tabs items={['npx', 'yarn', 'pnpm', 'bun']}>
  <Tab value="npx">
    ...
    # YAML出力
    npx netbox-to-shumoku -o network.yaml

    # インタラクティブHTML出力
    npx netbox-to-shumoku -o network.html

    # サイトでフィルタリング
    npx netbox-to-shumoku --site tokyo-dc -o tokyo.svg
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    # 基本的な使い方
    yarn dlx netbox-to-shumoku --url https://netbox.example.com --token YOUR_API_TOKEN

    # YAML出力
    yarn dlx netbox-to-shumoku -o network.yaml

    # インタラクティブHTML出力
    yarn dlx netbox-to-shumoku -o network.html

    # サイトでフィルタリング
    yarn dlx netbox-to-shumoku --site tokyo-dc -o tokyo.svg
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    # 基本的な使い方
    pnpm dlx netbox-to-shumoku --url https://netbox.example.com --token YOUR_API_TOKEN

    # YAML出力
    pnpm dlx netbox-to-shumoku -o network.yaml

    # インタラクティブHTML出力
    pnpm dlx netbox-to-shumoku -o network.html

    # サイトでフィルタリング
    pnpm dlx netbox-to-shumoku --site tokyo-dc -o tokyo.svg
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    # 基本的な使い方
    bunx netbox-to-shumoku --url https://netbox.example.com --token YOUR_API_TOKEN

    # YAML出力
    bunx netbox-to-shumoku -o network.yaml

    # インタラクティブHTML出力
    bunx netbox-to-shumoku -o network.html

    # サイトでフィルタリング
    bunx netbox-to-shumoku --site tokyo-dc -o tokyo.svg
    ```
  </Tab>
</Tabs>
...
| オプション | 説明 |
|-----------|------|
| `--output, -o` | 出力ファイル（.yaml, .svg, .html、デフォルト: topology.yaml） |
