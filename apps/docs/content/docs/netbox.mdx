...
<Tabs items={['npx', 'yarn', 'pnpm', 'bun']}>
  <Tab value="npx">
    ...
    # サイトでフィルタリング
    npx netbox-to-shumoku --site tokyo-dc
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    ...
    # サイトでフィルタリング
    yarn dlx netbox-to-shumoku --site tokyo-dc
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash
    ...
    # サイトでフィルタリング
    pnpm dlx netbox-to-shumoku --site tokyo-dc
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    ...
    # サイトでフィルタリング
    bunx netbox-to-shumoku --site tokyo-dc
    ```
  </Tab>
</Tabs>
