...
Example using all features: bandwidth, VLANs, HA, legends, etc.
...
For examples managing multiple sites in separate files, see [Multi-file Configuration](/docs/multi-file).
