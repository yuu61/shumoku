...
settings:
  ...
  theme: light           # Theme
  edgeStyle: orthogonal  # Edge routing style
  splineMode: sloppy     # Spline mode (when using splines)
...
### edgeStyle
Specifies the routing style for connection lines between nodes.
...
### splineMode
Specifies the curve behavior when using `edgeStyle: splines`.

| Value | Description |
|-------|-------------|
| `sloppy` | Smoother curves, may overlap nodes (default) |
